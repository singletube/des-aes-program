...
class Ui_MainWindow(object):
    ...
    def clicked(self):
        if not self.lineEdit.text():
            ...
            if len(kluch) != 16:
                QMessageBox.critical(MainWindow, "Ошибка ", "Длина ключа должна быть 16", QMessageBox.Ok)
                return 0
            if ok:
                ...
                with open(self.lineEdit_2.text(), 'w', encoding='UTF-8') as li:
                    try:
                        print(li.write(str(a)[2:][:-1]))
                    except ValueError:
                        pass
